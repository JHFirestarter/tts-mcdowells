...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { descrip: @drink.descrip, image: @drink.image, name: @drink.name, price: @drink.price }
    end
  ...
  test "should update drink" do
    patch :update, id: @drink, drink: { descrip: @drink.descrip, image: @drink.image, name: @drink.name, price: @drink.price }
    assert_redirected_to drink_path(assigns(:drink))
  end
