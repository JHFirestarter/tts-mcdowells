...
class EntreesControllerTest < ActionController::TestCase
  ...
  test "should create entree" do
    assert_difference('Entree.count') do
      post :create, entree: { descrip: @entree.descrip, image: @entree.image, like: @entree.like, name: @entree.name, price: @entree.price }
    end
  ...
  test "should update entree" do
    patch :update, id: @entree, entree: { descrip: @entree.descrip, image: @entree.image, like: @entree.like, name: @entree.name, price: @entree.price }
    assert_redirected_to entree_path(assigns(:entree))
  end
