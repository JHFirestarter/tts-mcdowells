...
class SidesControllerTest < ActionController::TestCase
  ...
  test "should create side" do
    assert_difference('Side.count') do
      post :create, side: { descrip: @side.descrip, image: @side.image, name: @side.name, price: @side.price }
    end
  ...
  test "should update side" do
    patch :update, id: @side, side: { descrip: @side.descrip, image: @side.image, name: @side.name, price: @side.price }
    assert_redirected_to side_path(assigns(:side))
  end
